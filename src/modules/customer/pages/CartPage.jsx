      ...
      <div className="container mx-auto px-4 py-8">
        <Card className="bg-white border border-gray-200">
          <div className="flex flex-col items-center justify-center min-h-[400px] gap-4">
            ...
            <Button onClick={() => navigate('/')} className="mt-4 !bg-purple-100 hover:!bg-purple-200 !text-purple-700">
              Ver Productos
            </Button>
          </div>
        </Card>
        ...
        <div className="lg:col-span-1">
          <Card className="sticky top-4 bg-white border border-gray-200">
            ...
            <Button 
              ...
              className="w-full !bg-purple-100 hover:!bg-purple-200 !text-purple-700 text-lg py-3 font-semibold"
            >
            ...
            <Button 
              onClick={() => navigate('/')}
              className="w-full mt-3 !bg-gray-100 hover:!bg-gray-200 !text-gray-700 font-medium"
