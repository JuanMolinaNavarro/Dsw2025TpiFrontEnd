       ...
       value: 8,
        message: 'La contraseña debe tener al menos 8 caracteres.',
         ...
         validate: {
          ...
          /[\W_]/.test(value) || 'La contraseña debe contener al menos un carácter especial.',
       },
     })}
...
/>
  ...
  <button 
  type='submit' 
  className="w-full bg-purple-200 hover:bg-purple-300 text-purple-800 font-medium py-2 px-4 rounded-lg transition-colors mt-4"
>
  Registrarse
 </button>
